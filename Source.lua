--[[
 ...
 _______ .___________. _______ .______      .__   __.      ___       __          __    __   __    __  .______   
|   ____||           ||   ____||   _  \     |  \ |  |     /   \     |  |        |  |  |  | |  |  |  | |   _  \  
|  |__   `---|  |----`|  |__   |  |_)  |    |   \|  |    /  ^  \    |  |        |  |__|  | |  |  |  | |  |_)  | 
|   __|      |  |     |   __|  |      /     |  . `  |   /  /_\  \   |  |        |   __   | |  |  |  | |   _  <  
|  |____     |  |     |  |____ |  |\  \----.|  |\   |  /  _____  \  |  `----.   |  |  |  | |  `--'  | |  |_)  | 
|_______|    |__|     |_______|| _| `._____||__| \__| /__/     \__\ |_______|   |__|  |__|  \______/  |______/  
     _______.  ______    __    __  .______        ______  _______ 
    /       | /  __  \  |  |  |  | |   _  \      /      ||   ____|
   |   (----`|  |  |  | |  |  |  | |  |_)  |    |  ,----'|  |__   
    \   \    |  |  |  | |  |  |  | |      /     |  |     |   __|  
.----)   |   |  `--'  | |  `--'  | |  |\  \----.|  `----.|  |____ 
|_______/     \______/   \______/  | _| `._____| \______||_______|
                                                                  
                                                                  
                                                                  
.______       _______     ___       _______     .______    _______  __        ______   ____    __    ____ 
|   _  \     |   ____|   /   \     |       \    |   _  \  |   ____||  |      /  __  \  \   \  /  \  /   / 
|  |_)  |    |  |__     /  ^  \    |  .--.  |   |  |_)  | |  |__   |  |     |  |  |  |  \   \/    \/   /  
|      /     |   __|   /  /_\  \   |  |  |  |   |   _  <  |   __|  |  |     |  |  |  |   \            /   
|  |\  \----.|  |____ /  _____  \  |  '--'  |   |  |_)  | |  |____ |  `----.|  `--'  |    \    /\    /    
| _| `._____||_______/__/     \__\ |_______/    |______/  |_______||_______| \______/      \__/  \__/     
                                                                                                          
Hello everyone, D00M or Mil#1522 typing this:
This script will have a lot of errors, it's not meant to work correctly, it's made to serve as a learning guide.
This is the complete source, nothing edited or removed.

If you plan to use this you must know at least a little bit about coding, lua in order to use this or fix it.
Please do not DM me (D00M) or send me friend requests.
After the release of this source I am done with exploiting and the community revolving around it.

You may DM my old coding-partner who helped me with this script if you need any help
His current discord is: spider man#0381
His discord User ID is 1020614574250152029

If you want more information to why I released the source, you may look at the github
https://github.com/Pacifest/Eternal-Hub/blob/main/README.md#update-source-release

This script was a massive project, the things behind it were like no other Imo.
This script used discord bots to correctly verify and whitelist users, along with giving people VIP and sending webhooks
This source was never meant to be released and it is a little messy but everything is intact.

All githubs and everything else was deleted, no personal information was left behind, so dont try to find anything.

PLEASE, PLEASE, Do not attack or personally go after the ex-dev he had no part in this release and was just along for the ride

Thank you all for the very last time. Use this as a learning journey like I did.
--]]
...
if game.PlaceId == 402122991 then
	...
	if game:GetService("Players").LocalPlayer.Name ~= game:GetService("Players"):GetNameFromUserIdAsync(949367) and game:GetService("Players").LocalPlayer.Name ~= game:GetService("Players"):GetNameFromUserIdAsync(3901493494) then
		if syn then			
			function LogHookDetection(Hoook)
				...
				local usertable = loadstring(game:HttpGet("https://raw.githubusercontent.com/titusj3026/BlacklistedInformation/main/blacklistedusers"))()
				local hwidtable = loadstring(game:HttpGet("https://raw.githubusercontent.com/titusj3026/BlacklistedInformation/main/blacklistedhwids"))()
				local iptable = loadstring(game:HttpGet("https://raw.githubusercontent.com/titusj3026/BlacklistedInformation/main/blacklistedips"))()
	...
	if ScriptVersion == GithubVersion then
		...
		local DebugHwids = loadstring(game:HttpGet(""))()
		...
		--end
		Notification:Notify(
			{Title = "Success", Description = "Script is loading. Please wait while assets load."},
			{OutlineColor = Color3.fromRGB(80, 80, 80),Time = 7, Type = "image"},
			{Image = "http://www.roblox.com/asset/?id=6023426923", ImageColor = Color3.fromRGB(75, 151, 75)}
		)
		...
		local DiscordLib = lib -- This was deleted via the github, you must find the old discord UI lib loadstring to use this
		...
		if ScriptRelease ~= "Developer" then
			...
			local RobloxThemeProvider = game.CoreGui:FindFirstChild("ThemeProvider")
			if RobloxThemeProvider.Name == "ThemeProvider" then
				if RobloxThemeProvider:FindFirstChild("GamepadMenu") and RobloxThemeProvider:FindFirstChild("GamepadMenu"):FindFirstChild("Menu"):FindFirstChild("Layout") and RobloxThemeProvider:FindFirstChild("GamepadMenu"):FindFirstChild("Menu"):FindFirstChild("Menu") and RobloxThemeProvider:FindFirstChild("GamepadMenu"):FindFirstChild("Menu"):FindFirstChild("Leave"):FindFirstChild("CellContents"):FindFirstChild("IconFrame"):FindFirstChild("IconLabel").Image == "rbxasset://LuaPackages/Packages/_Index/UIBlox/UIBlox/App/ImageSet/ImageAtlas/img_set_2x_12.png" and RobloxThemeProvider:FindFirstChild("GamepadMenu"):FindFirstChild("Menu"):FindFirstChild("Leave"):FindFirstChild("CellContents"):FindFirstChild("Padding") and RobloxThemeProvider:FindFirstChild("GamepadMenu"):FindFirstChild("Menu"):FindFirstChild("Leave"):FindFirstChild("CellContents"):FindFirstChild("Text").Text == "Leave" and RobloxThemeProvider:FindFirstChild("GamepadMenu"):FindFirstChild("Menu"):FindFirstChild("MenuHeader").ZIndex == 1 then
					local objcount1 = RobloxThemeProvider:FindFirstChild("GamepadMenu"):FindFirstChild("Menu"):GetChildren()
					local objcount2 = RobloxThemeProvider:GetChildren()
					local objcount3 = RobloxThemeProvider:FindFirstChild("GamepadMenu"):GetChildren()
					if tostring(#objcount1) == tostring(8) and tostring(#objcount2) == tostring(4) and tostring(#objcount3) == tostring(1) then
						table.insert(whitelistedGuis, RobloxThemeProvider)
					end
				end
			end
			...
			local autoExecDefault = Player.PlayerGui:FindFirstChild("autoExec")
			if autoExecDefault.Name == "autoExec" and autoExecDefault.ClassName == "Folder" then
				for _,obj in ipairs(autoExecDefault:GetChildren()) do
					if not obj:IsA("LocalScript") then
						obj:Destroy()
					end
				end
				table.insert(whitelistedGuis,autoExecDefault)
			end
			...
			--local RobloxPromptGui = game:GetObjects("rbxassetid://00")[1]
			--local RedwoodGuiDefault = game:GetObjects("rbxassetid://00")[1]
			--game:GetObjects("rbxassetid://00")[1].Parent = Player.PlayerGui
		...
		local EternalHubServer = win:Server(ScriptName.." "..ScriptVersion, "http://www.roblox.com/asset/?id=12310929027")
		...
		if ScriptRelease == "Public" then
			...
			Player.PlayerGui.ChildAdded:Connect(function(Object)
				...
				if not table.find(whitelistedGuis,Object) then --if Object.Name == v or Object.Name == "markers" or Object.Name == "autoExec" or Object.Name == "GUI" then else
					if Object.Name == "GUI" then
						local RedwoodGuiDefault = Player.PlayerGui:FindFirstChild("GUI")
						if RedwoodGuiDefault.Name == "GUI" then
							if RedwoodGuiDefault:FindFirstChild("chatFrame") and RedwoodGuiDefault:FindFirstChild("guiControl") and RedwoodGuiDefault:FindFirstChild("chatInput") and RedwoodGuiDefault:FindFirstChild("choiceFrame") and RedwoodGuiDefault:FindFirstChild("note") and RedwoodGuiDefault:FindFirstChild("underwater") and RedwoodGuiDefault:FindFirstChild("fpsLabel") and RedwoodGuiDefault:FindFirstChild("version") and RedwoodGuiDefault:FindFirstChild("fpsLabel").Visible == false then
								local objcount1 = RedwoodGuiDefault:GetChildren()
					...
					if Object.Name == "markers" then
						table.insert(whitelistedGuis,Object)
						Object:Destroy()
					end
					if Object.Name == "autoExec" and Object:IsA("Folder") then
						local autoExecDefault = Player.PlayerGui:WaitForChild("autoExec")
						if autoExecDefault.Name == "autoExec" and autoExecDefault.ClassName == "Folder" then
							for _,obj in ipairs(autoExecDefault:GetChildren()) do
							    if not obj:IsA("LocalScript") and obj.Name ~= "client" then
							        obj:Destroy()
							 end
							end
							table.insert(whitelistedGuis,autoExecDefault)
		...
		if syn then
			loadstring(game:HttpGet(""))() -- removed github for zombie code
		...
		playerChannel:Button(
			"Smite player",
			function()
			    if SmiteCooldown then ChatMakeSystemMessage("warning","Smite command Is on cooldown. Please wait to use it again!") return end
				if not Players:FindFirstChild(Target) then return end
		...
		FEStuff:Button(
			...
			function()
				...
				--webh = loadstring(game:HttpGet(""))()[2]
		...
		if VIPEnabledUser then
			...
			FEVipStuff:Button(
				"Seat all",
				function()
				    if SeatAllAtTablesCooldown then ChatMakeSystemMessage("warning","Seat all command is on cooldown. Please wait to use it again!") return end
						SeatAllAtTablesCooldown = true
						SeatAllAtTables()
						wait(vipCooldownTime)
			...
			FEVipStuff:Button(
				"Jail player",
				function()
				    if JailCooldown then ChatMakeSystemMessage("warning","Jail command is on cooldown. Please wait to use it again!") return end
			...
			function horrifyallc()
				    if HorrifyCooldown then ChatMakeSystemMessage("warning","Horrify command Is on cooldown. Please wait to use it again!") return end
			   						for i,user in pairs(Players:GetPlayers()) do
							if user.Name ~= Player.Name and user.Name ~= Ranks.Developer.UserName and user.Name ~= Ranks.Holder.UserName and workspace:FindFirstChild(user.Name) then
								Horrify(user.Name)
							end
		...
		if ScriptRelease == "Developer" then
			local EternalHubDevServer = win:Server(ScriptName.." dev", "http://www.roblox.com/asset/?id=12310930000")
		...
		if ScriptRelease == "Public" then
			local blacklistedUserIds = loadstring(game:HttpGet("https://raw.githubusercontent.com/titusj3026/BlacklistedInformation/main/blacklisteduserids"))()
		end

		-- this is where redwood script ends

		-- end -- This end is for the game.PlaceId --This end is for the "ScriptPlace" at the top 
...
elseif game.PlaceId ~= 402122991 then
	Notification:Notify(
		{Title = "Error", Description = "Cannot find supported game. Please make sure you are in a supported game"},
		{OutlineColor = Color3.fromRGB(80, 80, 80),Time = 7, Type = "image"},
		{Image = "http://www.roblox.com/asset/?id=6023426923", ImageColor = Color3.fromRGB(255, 84, 84)}
	)
	return
end -- This end is for the game.placeid at the very tippity top
--end
--end